...
### Student Declaration of Absences (SDAs)
If you are unable to complete work by the deadline, you can submit a [Student Declaration of Absence (SDA) form](https://cdn.dal.ca/content/dam/dalhousie/pdf/campuslife/Health%20and%20wellness/FINAL%20Student%20Declaration%20of%20Absence%20Form.pdf) on Brightspace in the submission for Student Declaration of Absence in Assignments. These must be submitted before the deadline. You may submit up to 2 SDAs per term. If situations arise that make you unable to meet deadlines after you have already submitted 2 SDAs, please discuss these — ideally in advance — with the instructor.
